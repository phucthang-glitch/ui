...
-- ============================================================
-- THEME: HỒNG NHẠT CHỦ ĐẠO (FULL PINK PASTEL)
-- Nền tím hồng sâu + accent hồng đậm sắc sỡ + chữ vàng/lavender sáng
-- ============================================================
local T1UIColor = {
    ["Border Color"]                  = Color3.fromRGB(255, 182, 193), -- hồng nhạt
    ["Click Effect Color"]            = Color3.fromRGB(255, 105, 150), -- xanh da trời
    ["Setting Icon Color"]            = Color3.fromRGB(250, 218, 221), -- hồng trắng nhạt
    ["Logo Image"]                    = "rbxassetid://123613996022560", -- logo khi menu HIỆN
    ["Logo Image 2"]                  = "rbxassetid://123613996022560", -- logo khi menu ẨN (thay ID này)
    ["Search Icon Color"]             = Color3.fromRGB(255, 105, 150), -- xanh da trời
    ["Search Icon Highlight Color"]   = Color3.fromRGB(255, 160, 190), -- xanh nhạt hơn
    ...
    ["Title Text Color"]              = Color3.fromRGB(255, 220, 240), -- hồng trắng sáng

    ["Background Main Color"]         = Color3.fromRGB(70, 40, 65),  -- tím hồng tối
    ["Background 1 Color"]            = Color3.fromRGB(85, 52, 78),  -- hồng tím lớp 1
    ["Background 1 Transparency"]     = 0.05,
    ["Background 2 Color"]            = Color3.fromRGB(95, 58, 88),  -- hồng tím lớp 2
    ["Background 3 Color"]            = Color3.fromRGB(80, 48, 74),  -- hồng tím lớp 3
    ["Background Image"]              = "",

    ["Page Selected Color"]           = Color3.fromRGB(255, 105, 150), -- xanh da trời
    ["Section Text Color"]            = Color3.fromRGB(255, 200, 230), -- hồng nhạt sáng
    ["Section Underline Color"]       = Color3.fromRGB(255, 105, 150), -- xanh da trời
    ["Toggle Border Color"]           = Color3.fromRGB(180, 100, 140), -- hồng tím vừa
    ["Toggle Checked Color"]          = Color3.fromRGB(255, 105, 150), -- xanh da trời
    ["Toggle Desc Color"]             = Color3.fromRGB(250, 218, 221), -- hồng trắng nhạt

    ["Button Color"]                  = Color3.fromRGB(95, 58, 88),  -- hồng tím nhạt
    ["Label Color"]                   = Color3.fromRGB(80, 48, 74),  -- hồng tím tối
    ["Dropdown Icon Color"]           = Color3.fromRGB(255, 105, 150), -- xanh da trời
    ["Dropdown Selected Color"]       = Color3.fromRGB(255, 105, 150), -- xanh da trời
    ["Dropdown Selected Check Color"] = Color3.fromRGB(255, 240, 180), -- vàng kem

    ["Textbox Highlight Color"]       = Color3.fromRGB(255, 105, 150), -- xanh da trời
    ["Box Highlight Color"]           = Color3.fromRGB(255, 182, 193), -- hồng nhạt
    ["Slider Line Color"]             = Color3.fromRGB(105, 65, 95),  -- hồng tím tối
    ["Slider Highlight Color"]        = Color3.fromRGB(255, 105, 150), -- xanh da trời
...
mainButton.BackgroundColor3 = Color3.fromRGB(85, 52, 78)
mainButton.BackgroundTransparency = 0
mainButton.AutoButtonColor = false
mainButton.Image = getgenv().UIColor["Logo Image"] -- logo khi menu HIỆN
...
-- HELPER: đổi logo theo trạng thái menu
local function updateLogo()
    if isToggled then
        -- Menu đang HIỆN → Logo 1
        mainButton.Image = getgenv().UIColor["Logo Image"]
    else
        -- Menu đang ẨN → Logo 2
        mainButton.Image = getgenv().UIColor["Logo Image 2"]
    end
end
...
UIStroke.Color = Color3.fromRGB(255, 105, 150)
		...
		if math.abs(delta.X) < CLICK_DISTANCE and math.abs(delta.Y) < CLICK_DISTANCE then
			...
			if isToggled then
				TweenService:Create(mainButton, tweenOn, {
					BackgroundColor3 = Color3.fromRGB(95, 58, 88)
				}):Play()
			else
				TweenService:Create(mainButton, tweenOff, {
					BackgroundColor3 = Color3.fromRGB(70, 40, 65)
				}):Play()
			end

			updateLogo() -- đổi logo theo trạng thái menu
...
mainButton.MouseEnter:Connect(function()
    ...
    TweenService:Create(mainButton, hoverTweenInfo, {
        BackgroundColor3 = Color3.fromRGB(80, 48, 74)
    }):Play()
end)

mainButton.MouseLeave:Connect(function()
    isHovering = false
    local targetColor = isToggled and Color3.fromRGB(70, 40, 65) or Color3.fromRGB(95, 58, 88)
...
NotiContainer.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
...
local libCreateNoti = function(Setting)
	...
	NotiFrame.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
	...
	Topnoti.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
	...
	Ruafimg.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
	...
	TextLabelNoti.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
	...
	CloseContainer.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
	...
	CloseImage.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
	...
	TextButton.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
	...
	if Description then
		...
		TextLabelNoti2.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
...
function Library:CreateWindow(Setting)
	...
	Main.BackgroundColor3 = Color3.fromRGB(85, 52, 78)
	...
	maingui.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
	...
	MainContainer.BackgroundColor3 = Color3.fromRGB(70, 40, 65)
	...
	uigradient.Color = ColorSequence.new{
		...
		ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 105, 150))
	}
	...
	Concacontainer.BackgroundColor3 = Color3.fromRGB(85, 52, 78)
	...
	Concacmain.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
	...
	TopMain.BackgroundColor3 = Color3.fromRGB(80, 48, 74)
	...
	TopStroke.BackgroundColor3 = Color3.fromRGB(255, 105, 150)
	...
	TextLabelMain.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
   ...
   TextLabelMain.Text = "<font color=\"rgb(255,180,220)\">" .. tostring(TitleNameMain or "Night Mystic") .. "</font> <font color=\"rgb(255,240,180)\">" .. tostring(getgenv().MainDesc or "") .. "</font>"
	...
	PageControl.BackgroundColor3 = Color3.fromRGB(60, 32, 54)
	PageControl.BackgroundTransparency = 0.1

	local pageControlStroke = Instance.new("UIStroke", PageControl)
	pageControlStroke.Color = Color3.fromRGB(220, 130, 165)
	...
	pageControlGradient.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(60, 32, 54)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(75, 42, 68))
	}
	...
	ControlList.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
	...
	ControlTitle.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
	...
	PageSearch.BackgroundColor3 = Color3.fromRGB(75, 42, 68)
	...
	SearchIcon.ImageColor3 = Color3.fromRGB(255, 160, 200)
	...
	MainPage.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
	...
	local PageCounter = 1
		...
		PageNameControl.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
		...
		Frame.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
		...
		Line.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
		...
		TabTitleContainer.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
		...
		TabTitle.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
		...
		PageButton.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
		...
		PageTitle.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
		...
		PageList.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			sectionStroke.Color = Color3.fromRGB(220, 130, 165)
			sectionStroke.Thickness = 1

			local sectionGradient = Instance.new("UIGradient", Section)
			sectionGradient.Color = ColorSequence.new{
				ColorSequenceKeypoint.new(0, Color3.fromRGB(75, 42, 68)),
			...
			Topsec.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
			Topsec.BackgroundTransparency = 1.000
			Topsec.Size = UDim2.new(0, 415, 0, 30)

			Sectiontitle.Name = "Sectiontitle"
			Sectiontitle.Parent = Topsec
			Sectiontitle.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
			...
			if Toggleable then
				...
				VisibilityButton.BorderColor3 = Color3.fromRGB(180, 100, 140)
				...
				VisibilitySectionFrame.BackgroundColor3 = Color3.fromRGB(85, 52, 78)
				VisibilitySectionFrame.BorderColor3 = Color3.fromRGB(180, 100, 140)
			...
			local sectionFunction = {}
				...
				ToggleFrame.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
				...
				TogFrame1.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
				...
				checkbox.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
				...
				check.BackgroundColor3 = Color3.fromRGB(255, 105, 150) -- xanh da trời (base)
				...
				if Desc and Desc ~= "" then
					...
					ToggleDesc.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
				...
				ToggleTitle.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
				...
				ToggleButton.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
    ...
    ButtonClick()
			...
			function sectionFunction:AddButton(Setting, Callback)
				...
				UIGradient_1.Color = ColorSequence.new{
					...
					ColorSequenceKeypoint.new(0.4, Color3.fromRGB(255, 160, 190)),
			...
			function sectionFunction:AddLabel(text)
                ...
                TextColor.TextColor3 = Color3.fromRGB(255, 200, 230)
            ...
            function sectionFunction:AddDropdownSection(Setting)
                ...
                DropdownFrame.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
                ...
                Dropdowntitle.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
                ...
                DropdownButton.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
                ...
                Dropdownlisttt.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
                
                DropdownScroll.Name = "DropdownScroll"
                DropdownScroll.Parent = Dropdownlisttt
                DropdownScroll.Active = true
                DropdownScroll.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
                ...
                ScrollContainer.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
                ...
                InternalSection.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
               ...
               local dropdownSectionFunction = {}
                ...
                function dropdownSectionFunction:AddSlider(Setting)
                    ...
                    SliderFrame.BackgroundColor3 = Color3.fromRGB(105, 65, 95)
                    ...
                    SliderBG.BackgroundColor3 = Color3.fromRGB(60, 32, 54)
                    ...
                    SliderTitle.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
                    ...
                    SliderButton.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
                    ...
                    Sliderbox_2.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
				...
				local function refreshlist(SortPairs)
					...
					if Selected then
                        for _, i in ipairs(OrderedList) do
							...
							SampleItem.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
							...
							SampleItemButton.BorderColor3 = Color3.fromRGB(180, 100, 140)
...
function sectionFunction:AddKeyBind(Setting, Callback)
    ...
    BindButtonTitle.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
    ...
    Bindkey.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
    ...
    return keybindFunction
			...
			function sectionFunction:AddInput(idk, Setting)
				...
				Boxtitle.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
				...
				Boxxx.Parent = BoxCor
				Boxxx.BackgroundColor3 = Color3.fromRGB(95, 58, 88)
