...
local T1UIColor = {
    ...
    ["GUI Text Color"]                = Color3.fromRGB(255, 210, 80),
    -- Text Color chính: trắng sáng (sáng tối xen nhau qua từng element)
    ["Text Color"]                    = Color3.fromRGB(235, 240, 255),
    ["Placeholder Text Color"]        = Color3.fromRGB(80, 60, 110),
    ["Title Text Color"]              = Color3.fromRGB(0, 210, 230),

    -- Background sáng tối xen kẽ
    ["Background Main Color"]         = Color3.fromRGB(14, 10, 22),   -- tím đen sâu
    ["Background 1 Color"]            = Color3.fromRGB(28, 20, 46),   -- tím tối (sáng hơn)
    ["Background 1 Transparency"]     = 0.0,
    ["Background 2 Color"]            = Color3.fromRGB(18, 13, 32),   -- tím đen (tối hơn)
    ["Background 3 Color"]            = Color3.fromRGB(22, 16, 38),   -- tím đen trung
    ["Background Image"]              = "",

    ["Page Selected Color"]           = Color3.fromRGB(0, 210, 230),
    -- Section: vàng nổi bật trên nền tối
    ["Section Text Color"]            = Color3.fromRGB(255, 200, 60),
    ["Section Underline Color"]       = Color3.fromRGB(255, 160, 40),
    -- Toggle: xanh lá check
    ["Toggle Border Color"]           = Color3.fromRGB(60, 180, 120),
    ["Toggle Checked Color"]          = Color3.fromRGB(80, 255, 160),
    ["Toggle Desc Color"]             = Color3.fromRGB(130, 110, 170),

    -- Button: nền sáng hơn section
    ["Button Color"]                  = Color3.fromRGB(36, 26, 58),
    ["Label Color"]                   = Color3.fromRGB(20, 14, 34),
    ...
    ["Slider Line Color"]             = Color3.fromRGB(35, 20, 55),
...
function Library:CreateWindow(Setting)
	...
	Shadow.ImageColor3 = Color3.fromRGB(120, 40, 220)
	...
	MainContainer.BackgroundColor3 = Color3.fromRGB(14, 10, 22)
	...
	bgGrad.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0,    Color3.fromRGB(28, 12, 50)),
		ColorSequenceKeypoint.new(0.35, Color3.fromRGB(10, 8, 20)),
		ColorSequenceKeypoint.new(0.65, Color3.fromRGB(8, 16, 32)),
		ColorSequenceKeypoint.new(1,    Color3.fromRGB(22, 10, 40))
	}
	bgGrad.Rotation = 145
	...
	TopBar.BackgroundColor3 = Color3.fromRGB(10, 7, 18)
	...
	TitleLabel.Text = "<font color=\"rgb(80,200,255)\">" .. tostring(TitleNameMain) .. "</font>"
	...
	SubLabel.TextColor3 = Color3.fromRGB(140, 110, 200)
	...
	SearchFrame.BackgroundColor3 = Color3.fromRGB(24, 16, 44)
	...
	sfStroke.Color = Color3.fromRGB(120, 60, 220)
	...
	SearchIcon.ImageColor3 = Color3.fromRGB(140, 80, 220)
	...
	SearchBox.PlaceholderColor3 = Color3.fromRGB(80, 55, 120)
	SearchBox.PlaceholderText = "Tìm..."
	SearchBox.Text = ""
	SearchBox.TextColor3 = Color3.fromRGB(200, 160, 255)
	...
	ClearBtn.TextColor3 = Color3.fromRGB(200, 100, 255)
	...
	function Main_Function:AddTab(PageName, IconId)
		...
		Frame.BackgroundColor3 = Color3.fromRGB(18, 12, 30)
		...
		TabTitle.TextColor3 = Color3.fromRGB(90, 70, 130)
		...
		for i, v in pairs(ControlList:GetChildren()) do
			if not v:IsA("UIListLayout") then
				if i == 2 then
					...
					v.Frame.BackgroundColor3 = Color3.fromRGB(36, 18, 64)
			...
			for _, v in next, ControlList:GetChildren() do
				if not v:IsA("UIListLayout") then
					...
					TweenService:Create(v.Frame,
						TweenInfo.new(getgenv().UIColor["Tween Animation 1 Speed"]),
						{
							BackgroundColor3 = isActive and Color3.fromRGB(22, 14, 42)
								or Color3.fromRGB(18, 12, 30),
					...
					TweenService:Create(v.Frame.TabTitleContainer.TabTitle,
						TweenInfo.new(getgenv().UIColor["Tween Animation 1 Speed"]),
						{ TextColor3 = isActive and tc or Color3.fromRGB(90, 70, 130) }):Play()
				end
			end
		end)
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			Section.BackgroundColor3 = Color3.fromRGB(24, 16, 42)
			Section.BackgroundTransparency = 0.05
			Section.ClipsDescendants = true

			local sectionStroke = Instance.new("UIStroke", Section)
			sectionStroke.Color = Color3.fromRGB(140, 60, 230)
			...
			Topsec.BackgroundColor3 = Color3.fromRGB(120, 60, 220)
			Topsec.BackgroundTransparency = 0.82
			...
			secAccentBar.BackgroundColor3 = Color3.fromRGB(180, 80, 255)
			...
			Sectiontitle.TextColor3 = Color3.fromRGB(255, 205, 60)
			...
			Linesec.BackgroundColor3 = Color3.fromRGB(0, 190, 230)
			...
			local sectionFunction = {}
				...
				checkbox.ImageColor3 = Color3.fromRGB(0, 200, 130)
				...
				ToggleTitle.TextColor3 = Color3.fromRGB(120, 255, 180)
				...
				toggleBgGrad.Color = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(32, 20, 52)),
    ...
    ButtonClick()
			...
			function sectionFunction:AddButton(Setting, Callback)
				...
				RowBG_1.BackgroundColor3 = Color3.fromRGB(36, 22, 60)
            ...
            function sectionFunction:AddDropdownSection(Setting)
                ...
                Dropdowntitle.TextColor3 = Color3.fromRGB(255, 110, 175)
               ...
               local dropdownSectionFunction = {}
                ...
                function dropdownSectionFunction:AddSlider(Setting)
                    ...
                    SliderTitle.TextColor3 = Color3.fromRGB(255, 215, 70)
                    ...
                    Sliderbox_2.TextColor3 = Color3.fromRGB(0, 210, 230)
				...
				local function refreshlist(SortPairs)
					...
					if Selected then
                        for _, i in ipairs(OrderedList) do
							...
							SampleItemButton.TextColor3 = Color3.fromRGB(225, 205, 255)
...
function sectionFunction:AddKeyBind(Setting, Callback)
    ...
    BindButtonTitle.TextColor3 = Color3.fromRGB(100, 185, 255)
    ...
    Bindkey.TextColor3 = Color3.fromRGB(80, 225, 205)
    ...
    return keybindFunction
			...
			function sectionFunction:AddInput(idk, Setting)
				...
				Boxtitle.TextColor3 = Color3.fromRGB(80, 235, 205)
				...
				Boxxx.TextColor3 = Color3.fromRGB(180, 230, 255)
