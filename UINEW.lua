...
local T1UIColor = {
    -- Accent / border
    ["Border Color"]                  = Color3.fromRGB(0, 210, 230),
    ["Click Effect Color"]            = Color3.fromRGB(160, 100, 255),
    ["Setting Icon Color"]            = Color3.fromRGB(180, 140, 255),
    ["Logo Image"]                    = "rbxassetid://123613996022560",
    ["Search Icon Color"]             = Color3.fromRGB(140, 80, 220),
    ["Search Icon Highlight Color"]   = Color3.fromRGB(200, 120, 255),
    ["GUI Text Color"]                = Color3.fromRGB(160, 100, 10),
    -- Text Color chính: trắng sáng (sáng tối xen nhau qua từng element)
    ["Text Color"]                    = Color3.fromRGB(50, 30, 100),
    ["Placeholder Text Color"]        = Color3.fromRGB(180, 165, 210),
    ["Title Text Color"]              = Color3.fromRGB(0, 210, 230),

    -- Background sáng tối xen kẽ
    ["Background Main Color"]         = Color3.fromRGB(245, 243, 255),   -- tím đen sâu
    ["Background 1 Color"]            = Color3.fromRGB(235, 230, 255),   -- tím tối (sáng hơn)
    ["Background 1 Transparency"]     = 0.0,
    ["Background 2 Color"]            = Color3.fromRGB(228, 222, 255),   -- tím đen (tối hơn)
    ["Background 3 Color"]            = Color3.fromRGB(238, 234, 255),   -- tím đen trung
    ["Background Image"]              = "",

    ["Page Selected Color"]           = Color3.fromRGB(0, 210, 230),
    -- Section: vàng nổi bật trên nền tối
    ["Section Text Color"]            = Color3.fromRGB(80, 30, 180),
    ["Section Underline Color"]       = Color3.fromRGB(130, 80, 220),
    -- Toggle: xanh lá check
    ["Toggle Border Color"]           = Color3.fromRGB(20, 140, 80),
    ["Toggle Checked Color"]          = Color3.fromRGB(30, 160, 90),
    ["Toggle Desc Color"]             = Color3.fromRGB(140, 120, 180),

    -- Button: nền sáng hơn section
    ["Button Color"]                  = Color3.fromRGB(230, 225, 255),
    ["Label Color"]                   = Color3.fromRGB(242, 240, 255),
    ["Dropdown Icon Color"]           = Color3.fromRGB(255, 100, 180),
    ["Dropdown Selected Color"]       = Color3.fromRGB(255, 100, 180),
    ["Dropdown Selected Check Color"] = Color3.fromRGB(80, 255, 160),

    ["Textbox Highlight Color"]       = Color3.fromRGB(0, 210, 230),
    ["Box Highlight Color"]           = Color3.fromRGB(0, 160, 180),
    ["Slider Line Color"]             = Color3.fromRGB(200, 190, 240),
    ["Slider Highlight Color"]        = Color3.fromRGB(255, 160, 40),
...
mainButton.BackgroundColor3 = Color3.fromRGB(220, 210, 255)
mainButton.BackgroundTransparency = 0
mainButton.AutoButtonColor = false
mainButton.Image = "rbxassetid://123613996022560"
mainButton.ImageColor3 = Color3.fromRGB(100, 40, 200)
...
UIS.InputEnded:Connect(function(input)
	...
	or input.UserInputType == Enum.UserInputType.Touch then
		...
		if math.abs(delta.X) < CLICK_DISTANCE and math.abs(delta.Y) < CLICK_DISTANCE then
			...
			if isToggled then
				TweenService:Create(mainButton, tweenOn, { BackgroundColor3 = Color3.fromRGB(220, 210, 255) }):Play()
			else
				TweenService:Create(mainButton, tweenOff, { BackgroundColor3 = Color3.fromRGB(200, 188, 248) }):Play()
			end
		end
		dragging = false
	end
...
mainButton.MouseEnter:Connect(function()
	...
	TweenService:Create(mainButton, hoverTweenInfo, { BackgroundColor3 = Color3.fromRGB(235, 225, 255) }):Play()
end)

mainButton.MouseLeave:Connect(function()
	local targetColor = isToggled and Color3.fromRGB(220, 210, 255) or Color3.fromRGB(200, 188, 248)
...
mainButton.MouseButton1Down:Connect(function()
	TweenService:Create(mainButton, hoverTweenInfo, { Size = UDim2.new(0, 54, 0, 54), BackgroundColor3 = Color3.fromRGB(235, 225, 255) }):Play()
end)
...
NotiContainer.BackgroundColor3 = Color3.fromRGB(240, 237, 255)
...
local libCreateNoti = function(Setting)
	...
	NotiFrame.BackgroundColor3 = Color3.fromRGB(232, 228, 255)
	...
	Noticontainer.BackgroundColor3 = Color3.fromRGB(225, 218, 255)
	...
	Title_1.TextColor3 = Color3.fromRGB(80, 30, 180)
...
function Library:CreateWindow(Setting)
	...
	local ControlList    = Instance.new("ScrollingFrame")   -- tab scroll ngang
	...
	local PageControl    = ControlList  -- alias compat
	...
	Shadow.ImageColor3 = Color3.fromRGB(160, 120, 240)
	...
	MainContainer.BackgroundColor3 = Color3.fromRGB(245, 243, 255)
	...
	bgGrad.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0,    Color3.fromRGB(235, 228, 255)),
		ColorSequenceKeypoint.new(0.35, Color3.fromRGB(248, 246, 255)),
		ColorSequenceKeypoint.new(0.65, Color3.fromRGB(240, 245, 255)),
		ColorSequenceKeypoint.new(1,    Color3.fromRGB(230, 225, 255))
	}
	bgGrad.Rotation = 145

	getgenv().ReadyForGuiLoaded = true

	-- -- TOP BAR (title 28px + tab bar 38px = 66px) ---------------
	TopBar.Name = "TopBar"
	TopBar.Parent = MainContainer
	TopBar.BackgroundColor3 = Color3.fromRGB(210, 200, 250)
	...
	local Logo = Instance.new("ImageLabel", TitleRow)
	...
	TitleLabel.Text = "<font color=\"rgb(60,20,140)\">" .. tostring(TitleNameMain) .. "</font>"

	local SubLabel = Instance.new("TextLabel", TitleRow)
	...
	SubLabel.TextColor3 = Color3.fromRGB(120, 90, 180)
	SubLabel.Text = tostring(getgenv().MainDesc or "")

	-- Divider dưới title
	local titleDiv = Instance.new("Frame", TitleRow)
	titleDiv.Size = UDim2.new(1, -20, 0, 1)
	titleDiv.Position = UDim2.new(0, 10, 1, -1)
	titleDiv.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	titleDiv.BackgroundTransparency = 0
	titleDiv.BorderSizePixel = 0
	local tdGrad = Instance.new("UIGradient", titleDiv)
	tdGrad.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 200, 255)),
		ColorSequenceKeypoint.new(0.5, Color3.fromRGB(180, 80, 255)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 80, 150))
	}

	-- TAB BAR ROW (38px) - nằm ngang, scroll X
	TabBarFrame.Name = "TabBarFrame"
	TabBarFrame.Parent = TopBar
	TabBarFrame.BackgroundTransparency = 1
	TabBarFrame.Position = UDim2.new(0, 0, 0, 28)
	TabBarFrame.Size = UDim2.new(1, 0, 0, 38)
	TabBarFrame.ClipsDescendants = true

	-- Search box bên phải tab bar
	local SearchFrame = Instance.new("Frame", TabBarFrame)
	SearchFrame.Name = "PageSearch"
	SearchFrame.AnchorPoint = Vector2.new(1, 0.5)
	SearchFrame.Position = UDim2.new(1, -6, 0.5, 0)
	SearchFrame.Size = UDim2.new(0, 105, 0, 26)
	SearchFrame.BackgroundColor3 = Color3.fromRGB(225, 218, 255)
	...
	sfStroke.Color = Color3.fromRGB(130, 80, 220)
	sfStroke.Thickness = 1
	sfStroke.Transparency = 0.45
	...
	SearchIcon.ImageColor3 = Color3.fromRGB(120, 70, 200)
	...
	SearchBox.PlaceholderColor3 = Color3.fromRGB(180, 165, 210)
	SearchBox.PlaceholderText = "Tìm..."
	SearchBox.Text = ""
	SearchBox.TextColor3 = Color3.fromRGB(70, 30, 160)
	SearchBox.TextSize = 11
	SearchBox.TextXAlignment = Enum.TextXAlignment.Left
	SearchBox.CursorPosition = -1

	-- ScrollingFrame chứa tab buttons (scroll ngang)
	ControlList.Name = "ControlList"
	ControlList.Parent = TabBarFrame
	ControlList.BackgroundTransparency = 1
	ControlList.BorderSizePixel = 0
	ControlList.Position = UDim2.new(0, 4, 0, 3)
	ControlList.Size = UDim2.new(1, -118, 0, 32)
	ControlList.CanvasSize = UDim2.new(0, 0, 0, 0)
	ControlList.ScrollBarThickness = 0        -- ẩn scrollbar vì tab bar
	...
	-- Update canvas width khi tabs thay đổi
	UIListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
		ControlList.CanvasSize = UDim2.new(0, UIListLayout.AbsoluteContentSize.X + 10, 0, 0)
	end)

	-- Divider dưới tab bar
	local tabDiv = Instance.new("Frame", MainContainer)
	tabDiv.Size = UDim2.new(1, -20, 0, 1)
	tabDiv.Position = UDim2.new(0, 10, 0, 66)
	tabDiv.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	tabDiv.BorderSizePixel = 0
	local tbGrad = Instance.new("UIGradient", tabDiv)
	...
	Concacontainer.Position = UDim2.new(0, 0, 0, 67)
	Concacontainer.Size = UDim2.new(1, 0, 1, -67)
	...
	MainPage.Position = UDim2.new(0, 6, 0, 4)
	MainPage.Size = UDim2.new(1, -12, 1, -8)
	...
	-- -- SEARCH LOGIC --------------------------------------------
	-- Hàm bỏ dấu tiếng Việt và chuẩn hoá chuỗi để so sánh
	local function normalizeStr(s)
		s = string.lower(tostring(s or ""))
		-- bỏ dấu tiếng Việt thường gặp
		local map = {
			["à"]="a",["á"]="a",["ả"]="a",["ã"]="a",["ạ"]="a",
	...
	-- Fuzzy match: tất cả ký tự trong query phải xuất hiện theo thứ tự trong target
	local function fuzzyMatch(target, query)
		if query == "" then return true end
		target = normalizeStr(target)
		query  = normalizeStr(query)
		-- Partial: nếu query là substring thì match ngay
		if string.find(target, query, 1, true) then return true end
		-- Fuzzy: từng ký tự của query phải xuất hiện tuần tự trong target
		local ti = 1
		for qi = 1, #query do
			local qc = query:sub(qi, qi)
			local found = false
			while ti <= #target do
				if target:sub(ti, ti) == qc then
					ti = ti + 1
					found = true
					break
				end
		...
		GlobalSearch = function(searchText)
			...
			for section, elems in pairs(elementsInSection) do
				...
				for _, ei in ipairs(elems) do
					if ei.ef then hasElementMatch = true end
				end
				for _, ei in ipairs(elems) do
					local c = ei.control
					if ei.ef then
						-- Chức năng khớp: hiện chức năng + section
						c.Element.Visible = true
						c.Section.Visible = true
						foundTabs[c.TabName] = true
					elseif ei.sf then
						-- Section khớp: hiện toàn bộ section
						c.Element.Visible = true
						c.Section.Visible = true
						foundTabs[c.TabName] = true
					elseif ei.tf then
						-- Tab khớp: hiện toàn bộ tab
						c.Element.Visible = true
						c.Section.Visible = true
						foundTabs[c.TabName] = true
					end
	...
	-- SearchBox events: Text change + FocusLost (thoát search)
	...
	ClearBtn.Position = UDim2.new(1, -3, 0.5, 0)
	ClearBtn.Size = UDim2.new(0, 18, 0, 18)
	ClearBtn.BackgroundTransparency = 1
	ClearBtn.Text = "X"
	ClearBtn.Font = Enum.Font.GothamBold
	ClearBtn.TextSize = 10
	ClearBtn.TextColor3 = Color3.fromRGB(140, 60, 200)
	...
	-- FocusLost: nếu bấm ra ngoài mà không nhập gì -> clear
	...
	-- ============================================================
	-- ADD TAB  -  HORIZONTAL, FIXED WIDTH, SCROLLABLE
	-- ============================================================
	function Main_Function:AddTab(PageName, IconId)
		...
		-- Tính width tab: text ~12px/char + icon + padding
		local titleLen = utf8.len(Page_Name) or #Page_Name
		local TAB_W = math.clamp(titleLen * 11 + 28, 70, 130)
		if IconId and IconId ~= "" then TAB_W = TAB_W + 18 end
		...
		Frame.BackgroundColor3 = Color3.fromRGB(235, 230, 255)
		Frame.BackgroundTransparency = 0.15
		Frame.Size = UDim2.new(1, 0, 1, 0)
		Frame.ClipsDescendants = false

		TabNameCorner.CornerRadius = UDim.new(0, 6)
		TabNameCorner.Parent = Frame

		local frameStroke = Instance.new("UIStroke", Frame)
		frameStroke.Color = tabColor
		...
		InLine.Position = UDim2.new(0.5, 0, 1, 0)
		InLine.Size = UDim2.new(0.75, 0, 0, 2)
		...
		-- Tab title - position absolute, không dùng AutomaticSize
		...
		TabTitleContainer.Size = UDim2.new(1, -iconOffset - 4, 1, 0)
		...
		TabTitle.TextColor3 = Color3.fromRGB(150, 120, 200)
		TabTitle.TextTruncate = Enum.TextTruncate.AtEnd

		-- PageButton phủ toàn bộ tab, ZIndex cao để nhận click
		...
		for i, v in pairs(ControlList:GetChildren()) do
			if not v:IsA("UIListLayout") then
				if i == 2 then
					...
					v.Frame.BackgroundColor3 = Color3.fromRGB(200, 185, 255)
					v.Frame.BackgroundTransparency = 0
					local fs = v.Frame:FindFirstChildOfClass("UIStroke")
					if fs then fs.Transparency = 0.1 end
					v.Frame.TabTitleContainer.TabTitle.TextColor3 = tabColor
				end
			end
		end
		...
		PageButton.MouseButton1Click:Connect(function()
			...
			for _, v in next, ControlList:GetChildren() do
				if not v:IsA("UIListLayout") then
					...
					TweenService:Create(v.Frame.Line.PageInLine,
						TweenInfo.new(getgenv().UIColor["Tween Animation 1 Speed"]),
						{ BackgroundTransparency = isActive and 0 or 1 }):Play()

					TweenService:Create(v.Frame,
						TweenInfo.new(getgenv().UIColor["Tween Animation 1 Speed"]),
						{
							BackgroundColor3 = isActive and Color3.fromRGB(200, 185, 255)
								or Color3.fromRGB(235, 230, 255),
							BackgroundTransparency = isActive and 0 or 0.15
						}):Play()

					if fs then
						TweenService:Create(fs,
							TweenInfo.new(getgenv().UIColor["Tween Animation 1 Speed"]),
							{ Transparency = isActive and 0.15 or 0.6 }):Play()
					end

					TweenService:Create(v.Frame.TabTitleContainer.TabTitle,
						TweenInfo.new(getgenv().UIColor["Tween Animation 1 Speed"]),
						{ TextColor3 = isActive and tc or Color3.fromRGB(150, 120, 200) }):Play()
				end
			end
		end)
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			Section.BackgroundColor3 = Color3.fromRGB(240, 237, 255)
			Section.BackgroundTransparency = 0.05
			Section.ClipsDescendants = true

			local sectionStroke = Instance.new("UIStroke", Section)
			sectionStroke.Color = Color3.fromRGB(160, 110, 230)
			sectionStroke.Thickness = 1
			sectionStroke.Transparency = 0.5

			local sectionGradient = Instance.new("UIGradient", Section)
			sectionGradient.Color = ColorSequence.new{
				ColorSequenceKeypoint.new(0, Color3.fromRGB(242, 238, 255)),
				ColorSequenceKeypoint.new(1, Color3.fromRGB(248, 245, 255))
			}
			...
			Topsec.BackgroundColor3 = Color3.fromRGB(170, 130, 240)
			Topsec.BackgroundTransparency = 0.0
			...
			topsecGrad.Color = ColorSequence.new{
					...
					ColorSequenceKeypoint.new(0.6, Color3.fromRGB(155, 115, 240)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(135, 95, 225))
				}
			...
			secAccentBar.BackgroundColor3 = Color3.fromRGB(100, 40, 200)
			...
			Sectiontitle.BackgroundColor3 = Color3.fromRGB(170, 130, 240)
			...
			Linesec.BackgroundColor3 = Color3.fromRGB(120, 70, 210)
			...
			LineShadow.BackgroundColor3 = Color3.fromRGB(200, 190, 240)
			...
			if Toggleable then
				...
				VisibilityButton.BackgroundColor3 = Color3.fromRGB(170, 130, 240)
				...
				VisibilitySectionFrame.BackgroundColor3 = Color3.fromRGB(225, 218, 252)
			...
			local sectionFunction = {}
				...
				ToggleFrame.BackgroundColor3 = Color3.fromRGB(240, 237, 255)
				...
				TogFrame1.BackgroundColor3 = Color3.fromRGB(240, 237, 255)
				...
				checkbox.BackgroundColor3 = Color3.fromRGB(240, 237, 255)
				checkbox.BackgroundTransparency = 1.000
				checkbox.Position = UDim2.new(1, -5, 0.5, 0)
				checkbox.Size = UDim2.new(0, 20, 0, 20)
				checkbox.Image = "rbxassetid://4552505888"
				checkbox.ImageColor3 = Color3.fromRGB(20, 140, 80)
				
				check.Name = "check"
				check.Parent = checkbox
				check.AnchorPoint = Vector2.new(0.5, 0.5)
				check.BackgroundColor3 = Color3.fromRGB(30, 160, 90) -- xanh da trời (base)
				...
				checkGradient.Color = ColorSequence.new({
					ColorSequenceKeypoint.new(0, Color3.fromRGB(20, 150, 85)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(40, 180, 105)),
				})
				...
				if Desc and Desc ~= "" then
					...
					ToggleDesc.BackgroundColor3 = Color3.fromRGB(240, 237, 255)
					...
					ToggleDesc.TextColor3 = Color3.fromRGB(140, 120, 180)
				...
				ToggleTitle.BackgroundColor3 = Color3.fromRGB(240, 237, 255)
				...
				ToggleTitle.TextColor3 = Color3.fromRGB(20, 130, 75)
				...
				toggleBgGrad.Color = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(245, 242, 255)),
							ColorSequenceKeypoint.new(1, Color3.fromRGB(238, 234, 255))
				}
				toggleBgGrad.Rotation = 0
				ToggleBg.ZIndex = 0
				ToggleBg.BackgroundColor3 = Color3.fromRGB(238, 234, 255)
				...
				ToggleButton.BackgroundColor3 = Color3.fromRGB(240, 237, 255)
				ToggleButton.BackgroundTransparency = 1.000
				ToggleButton.Size = UDim2.new(1, 0, 1, 0)
				ToggleButton.Position = UDim2.new(0, 0, 0, 0)
				ToggleButton.Font = Enum.Font.SourceSans
				ToggleButton.Text = ""
				ToggleButton.TextColor3 = Color3.fromRGB(20, 130, 75)
    ...
    ButtonClick()
			...
			function sectionFunction:AddButton(Setting, Callback)
				...
				Button.BackgroundColor3 = Color3.fromRGB(238, 234, 255)
				...
				RowBG_1.BackgroundColor3 = Color3.fromRGB(218, 208, 255)
				...
				RowHover_1.BackgroundColor3 = Color3.fromRGB(205, 195, 250)
				...
				TextColor_1.BackgroundColor3 = Color3.fromRGB(238, 234, 255)
				...
				TextColor_1.TextColor3 = Color3.fromRGB(180, 90, 10)
				...
				if Desc and Desc ~= "" then
					...
					TextDesc.BackgroundColor3 = Color3.fromRGB(238, 234, 255)
					...
					TextDesc.Text = Desc
					TextDesc.TextColor3 = Color3.fromRGB(140, 120, 180)
				...
				ImageLabel_1.BackgroundColor3 = Color3.fromRGB(238, 234, 255)
			...
			function sectionFunction:AddLabel(text)
                ...
                LabelFrame.BackgroundColor3 = Color3.fromRGB(242, 240, 255)
                ...
                LabelBG.BackgroundColor3 = Color3.fromRGB(228, 222, 252)
                ...
                TextColor.BackgroundColor3 = Color3.fromRGB(242, 240, 255)
                ...
                TextColor.TextColor3 = Color3.fromRGB(60, 100, 180)
            ...
            function sectionFunction:AddDropdownSection(Setting)
                ...
                DropdownFrame.BackgroundColor3 = Color3.fromRGB(240, 237, 255)
                ...
                Dropdownbg.BackgroundColor3 = Color3.fromRGB(235, 230, 255)
                ...
                Topdrop.BackgroundColor3 = Color3.fromRGB(225, 218, 252)
                ...
                Dropdowntitle.BackgroundColor3 = Color3.fromRGB(240, 237, 255)
                ...
                Dropdowntitle.TextColor3 = Color3.fromRGB(180, 30, 100)
                ...
                DropdownButton.BackgroundColor3 = Color3.fromRGB(240, 237, 255)
                ...
                DropdownButton.Text = ""
                DropdownButton.TextColor3 = Color3.fromRGB(180, 30, 100)
                ...
                Dropdownlisttt.BackgroundColor3 = Color3.fromRGB(240, 237, 255)
                
                DropdownScroll.Name = "DropdownScroll"
                DropdownScroll.Parent = Dropdownlisttt
                DropdownScroll.Active = true
                DropdownScroll.BackgroundColor3 = Color3.fromRGB(240, 237, 255)
                ...
                ScrollContainer.BackgroundColor3 = Color3.fromRGB(240, 237, 255)
                ...
                InternalSection.BackgroundColor3 = Color3.fromRGB(240, 237, 255)
               ...
               local dropdownSectionFunction = {}
                ...
                function dropdownSectionFunction:AddSlider(Setting)
                    ...
                    SliderFrame.BackgroundColor3 = Color3.fromRGB(238, 234, 255)
                    ...
                    SliderBG.BackgroundColor3 = Color3.fromRGB(228, 222, 252)
                    ...
                    SliderTitle.BackgroundColor3 = Color3.fromRGB(238, 234, 255)
                    ...
                    SliderTitle.TextColor3 = Color3.fromRGB(140, 90, 0)
                    ...
                    SliderBar.BackgroundColor3 = Color3.fromRGB(215, 208, 248)
                    
                    SliderButton.Name = "SliderButton"
                    SliderButton.Parent = SliderBar
                    SliderButton.BackgroundColor3 = Color3.fromRGB(200, 180, 250)
                    SliderButton.BackgroundTransparency = 1.000
                    SliderButton.Size = UDim2.new(1, 0, 1, 0)
                    SliderButton.Font = Enum.Font.GothamBold
                    SliderButton.Text = ""
                    SliderButton.TextColor3 = Color3.fromRGB(100, 60, 180)
                    ...
                    Bar.BackgroundColor3 = Color3.fromRGB(200, 190, 240)
                    ...
                    Sliderboxframe.BackgroundColor3 = Color3.fromRGB(215, 208, 248)
                    ...
                    Sliderbox_2.BackgroundColor3 = Color3.fromRGB(215, 208, 248)
                    ...
                    Sliderbox_2.TextColor3 = Color3.fromRGB(100, 60, 180)
                    
                    SliderButton.MouseEnter:Connect(function()
                        TweenService:Create(Bar, TweenInfo.new(getgenv().UIColor["Tween Animation 2 Speed"]), {
                            BackgroundColor3 = Color3.fromRGB(140, 90, 0)
                        }):Play()
                    end)
				...
				local function refreshlist(SortPairs)
					...
					if Selected then
                        for _, i in ipairs(OrderedList) do
							...
							SampleItem.BackgroundColor3 = Color3.fromRGB(228, 222, 252)
							...
							SampleItemBG.BackgroundColor3 = v and Color3.fromRGB(30, 160, 90) or Color3.fromRGB(200, 190, 240)
							...
							SampleItemTitle.BackgroundColor3 = Color3.fromRGB(228, 222, 252)
							...
							SampleItemButton.TextColor3 = Color3.fromRGB(70, 30, 140)
...
function sectionFunction:AddKeyBind(Setting, Callback)
    ...
    BindFrame.BackgroundColor3 = Color3.fromRGB(238, 234, 255)
    ...
    BindButtonTitle.BackgroundColor3 = Color3.fromRGB(238, 234, 255)
    ...
    BindButtonTitle.TextColor3 = Color3.fromRGB(20, 70, 190)
    ...
    Bindkey.BackgroundColor3 = Color3.fromRGB(225, 218, 252)
    ...
    Bindkey.TextColor3 = Color3.fromRGB(10, 110, 120)
    ...
    return keybindFunction
			...
			function sectionFunction:AddInput(idk, Setting)
				...
				BoxFrame.BackgroundColor3 = Color3.fromRGB(238, 234, 255)
				...
				Boxtitle.BackgroundColor3 = Color3.fromRGB(238, 234, 255)
				...
				Boxtitle.TextColor3 = Color3.fromRGB(10, 110, 120)
				...
				Boxxx.Parent = BoxCor
				Boxxx.BackgroundColor3 = Color3.fromRGB(225, 218, 252)
				...
				Boxxx.TextColor3 = Color3.fromRGB(50, 80, 160)
