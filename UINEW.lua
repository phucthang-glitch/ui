...
local T1UIColor = {
    -- Accent / border
    ["Border Color"]                  = Color3.fromRGB(255, 130, 175),
    ...
    ["Search Icon Color"]             = Color3.fromRGB(255, 130, 175),
...
mainBtnGrad.Color = ColorSequence.new{
	ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 130, 175)),
		ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 80, 130)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 130, 175))
}
...
UIStroke.Color = Color3.fromRGB(255, 130, 175)
...
local NOTI_TYPES = {
	...
	default = {
		...
		accent   = Color3.fromRGB(255, 130, 175),
...
function Library:CreateWindow(Setting)
	...
	MainContainer.BackgroundColor3 = Color3.fromRGB(252, 248, 252)
	...
	mainStroke.Color = Color3.fromRGB(255, 140, 180)
	...
	Sidebar.BackgroundColor3 = Color3.fromRGB(255, 90, 140)
	...
	topBorderLine.BackgroundColor3 = Color3.fromRGB(255, 180, 210)
	topBorderLine.BackgroundTransparency = 0.3
	...
	SubLbl.TextColor3 = Color3.fromRGB(255, 240, 250)
	SubLbl.Text = tostring(getgenv().MainDesc or "")
	SubLbl.ZIndex = 3

	-- Divider dọc phân cách header và tabs
	...
	ContentBg.BackgroundColor3 = Color3.fromRGB(252, 248, 252)
	...
	contentStroke.Color = Color3.fromRGB(255, 140, 180)
	...
	function Main_Function:AddTab(PageName, IconId)
		...
		-- Bottom accent bar (visible when active)
		local BottomAccent = Instance.new("Frame", Frame)
		BottomAccent.Name = "LeftAccent"  -- giữ tên cho click handler
		BottomAccent.Size = UDim2.new(0.7, 0, 0, 3)
		BottomAccent.AnchorPoint = Vector2.new(0.5, 1)
		BottomAccent.Position = UDim2.new(0.5, 0, 1, 0)
		BottomAccent.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				...
				if not v:IsA("UIListLayout") then
					...
					if vF then
						TweenService:Create(vF, TweenInfo.new(0.18), {
							BackgroundColor3 = Color3.fromRGB(255, 255, 255),
							BackgroundTransparency = isA and 0.15 or 1,
						}):Play()
		...
		PageButton.MouseLeave:Connect(function()
			if Frame.BackgroundTransparency < 0.9 and Frame.BackgroundTransparency > 0.2 then
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			sectionStroke.Color = Color3.fromRGB(255, 160, 195)
			...
			topsecGlow.ImageColor3 = Color3.fromRGB(255, 130, 175)
			...
			Topsec.BackgroundColor3 = Color3.fromRGB(255, 190, 215)
			...
			topsecGrad.Color = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 150, 190)),
					ColorSequenceKeypoint.new(0.6, Color3.fromRGB(255, 130, 175)),
			...
			secAccentBar.BackgroundColor3 = Color3.fromRGB(255, 130, 175)
			...
			Sectiontitle.BackgroundColor3 = Color3.fromRGB(255, 140, 180)
			Sectiontitle.BackgroundTransparency = 1.000
			Sectiontitle.Position = UDim2.new(0, 10, 0, 0)
			Sectiontitle.Size = UDim2.new(1, -10, 1, 0)
			Sectiontitle.Font = Enum.Font.GothamBlack
			Sectiontitle.RichText = true
			Sectiontitle.Text = "<font color=\"rgb(255,90,145)\">[</font> " .. Section_Name .. "<font color=\"rgb(255,90,145)\">]</font>"
			Sectiontitle.TextSize = 12
			Sectiontitle.TextColor3 = Color3.fromRGB(200, 60, 110)
			...
			Linesec.BackgroundColor3 = Color3.fromRGB(255, 130, 175)
			...
			LineShadow.BackgroundColor3 = Color3.fromRGB(255, 170, 205)
			...
			if Toggleable then
				...
				VisibilitySectionFrame.BackgroundColor3 = Color3.fromRGB(255, 170, 205)
			...
			local sectionFunction = {}
				...
				if Desc and Desc ~= "" then
					...
					ToggleDesc.TextColor3 = Color3.fromRGB(150, 100, 130)
				...
				ToggleTitle.TextColor3 = Color3.fromRGB(50, 25, 45)
				...
				toggleBgGrad.Color = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 250, 254))
				}
    ...
    ButtonClick()
			...
			function sectionFunction:AddButton(Setting, Callback)
				...
				RowHover_1.BackgroundColor3 = Color3.fromRGB(255, 220, 238)
				...
				TextColor_1.TextColor3 = Color3.fromRGB(220, 60, 110)
				...
				if Desc and Desc ~= "" then
					...
					TextDesc.Text = Desc
					TextDesc.TextColor3 = Color3.fromRGB(150, 100, 130)
				...
				UIGradient_1.Color = ColorSequence.new{
					...
					ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 100, 155))
				}
            ...
            function sectionFunction:AddDropdownSection(Setting)
               ...
               local dropdownSectionFunction = {}
                ...
                function dropdownSectionFunction:AddSlider(Setting)
                    ...
                    SliderButton.BackgroundColor3 = Color3.fromRGB(255, 130, 175)
				...
				local function refreshlist(SortPairs)
					...
					if Selected then
                        for _, i in ipairs(OrderedList) do
							...
							SampleItemButton.TextColor3 = Color3.fromRGB(180, 90, 135)
