...
function Library:CreateWindow(Setting)
	...
	MainContainer.BackgroundColor3 = Color3.fromRGB(55, 28, 42)
	...
	Sidebar.BackgroundColor3 = Color3.fromRGB(38, 18, 28)
	...
	sideGrad.Color = ColorSequence.new{
		...
		ColorSequenceKeypoint.new(1, Color3.fromRGB(34, 16, 26))
	}
	...
	SearchFrame.BackgroundColor3 = Color3.fromRGB(48, 22, 35)
	...
	ContentBg.BackgroundColor3 = Color3.fromRGB(50, 24, 36)
	...
	contentGrad.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(54, 26, 40)),
	...
	function Main_Function:AddTab(PageName, IconId)
		...
		if LayoutOrderBut == 0 then
			...
			ActiveBar.Position = UDim2.new(0, 4, 0, tabY - 86)
		end
		...
		PageButton.MouseButton1Click:Connect(function()
			...
			TweenService:Create(ActiveBar,
				...
				{ Position = UDim2.new(0, 4, 0, tabY - 86) }):Play()
