...
local T1UIColor = {
    -- Accent / border
    ["Border Color"]                  = Color3.fromRGB(255, 100, 160),
    ...
    ["Search Icon Color"]             = Color3.fromRGB(255, 100, 160),
    ["Search Icon Highlight Color"]   = Color3.fromRGB(255, 180, 210),
    ["GUI Text Color"]                = Color3.fromRGB(255, 200, 100),
    -- Text Color chính
    ["Text Color"]                    = Color3.fromRGB(255, 225, 240),
    ["Placeholder Text Color"]        = Color3.fromRGB(140, 85, 110),
    ["Title Text Color"]              = Color3.fromRGB(255, 190, 215),

    -- Background sáng hơn
    ["Background Main Color"]         = Color3.fromRGB(52, 28, 40),
    ["Background 1 Color"]            = Color3.fromRGB(72, 38, 56),
    ["Background 1 Transparency"]     = 0.0,
    ["Background 2 Color"]            = Color3.fromRGB(60, 30, 46),
    ["Background 3 Color"]            = Color3.fromRGB(66, 34, 50),
    ["Background Image"]              = "",

    ["Page Selected Color"]           = Color3.fromRGB(0, 220, 240),
    ["Section Text Color"]            = Color3.fromRGB(255, 225, 240),
    ["Section Underline Color"]       = Color3.fromRGB(255, 100, 160),
    ["Toggle Border Color"]           = Color3.fromRGB(80, 255, 170),
    ["Toggle Checked Color"]          = Color3.fromRGB(80, 255, 170),
    ["Toggle Desc Color"]             = Color3.fromRGB(190, 140, 165),

    ["Button Color"]                  = Color3.fromRGB(80, 42, 62),
    ["Label Color"]                   = Color3.fromRGB(58, 30, 44),
    ["Dropdown Icon Color"]           = Color3.fromRGB(255, 140, 200),
    ["Dropdown Selected Color"]       = Color3.fromRGB(255, 100, 160),
    ["Dropdown Selected Check Color"] = Color3.fromRGB(80, 255, 170),

    ["Textbox Highlight Color"]       = Color3.fromRGB(255, 100, 160),
    ["Box Highlight Color"]           = Color3.fromRGB(210, 90, 130),
    ["Slider Line Color"]             = Color3.fromRGB(90, 46, 68),
    ["Slider Highlight Color"]        = Color3.fromRGB(255, 100, 160),
...
local libCreateNoti = function(Setting)
	...
	NotiFrame.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
...
function Library:CreateWindow(Setting)
	...
	bgGrad.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0,    Color3.fromRGB(82, 42, 62)),
		ColorSequenceKeypoint.new(0.5,  Color3.fromRGB(68, 34, 52)),
		ColorSequenceKeypoint.new(1,    Color3.fromRGB(76, 38, 58))
	}
	bgGrad.Rotation = 120
	...
	ActiveBar.Position = UDim2.new(0, 4, 0, 86)  -- sẽ update khi click tab
	...
	contentGrad.Color = ColorSequence.new{
		...
		ColorSequenceKeypoint.new(1, Color3.fromRGB(62, 30, 48))
	}
	...
	function Main_Function:AddTab(PageName, IconId)
		...
		Frame.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
		...
		if LayoutOrderBut == 0 then
			...
			-- Đặt indicator bar tại vị trí tab đầu
			ActiveBar.Position = UDim2.new(0, 4, 0, tabY)
		end
		...
		PageButton.MouseButton1Click:Connect(function()
			...
			-- Trượt ActiveBar tới vị trí tab này
			TweenService:Create(ActiveBar,
				TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{ Position = UDim2.new(0, 4, 0, tabY) }):Play()
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			Section.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
			...
			local sectionFunction = {}
				...
				ToggleFrame.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
				...
				TogFrame1.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
				...
				checkbox.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
				...
				if Desc and Desc ~= "" then
					...
					ToggleDesc.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
				...
				ToggleTitle.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
				...
				ToggleBg.ZIndex = 0
				ToggleBg.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
				...
				ToggleButton.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
    ...
    ButtonClick()
			...
			function sectionFunction:AddButton(Setting, Callback)
				...
				Button.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
				...
				TextColor_1.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
				...
				if Desc and Desc ~= "" then
					...
					TextDesc.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
				...
				ImageLabel_1.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
				...
				Button_1.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
            ...
            function sectionFunction:AddDropdownSection(Setting)
                ...
                DropdownFrame.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
                ...
                Dropdowntitle.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
                ...
                DropdownButton.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
                ...
                Dropdownlisttt.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
                
                DropdownScroll.Name = "DropdownScroll"
                DropdownScroll.Parent = Dropdownlisttt
                DropdownScroll.Active = true
                DropdownScroll.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
                ...
                ScrollContainer.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
                ...
                InternalSection.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
               ...
               local dropdownSectionFunction = {}
                ...
                function dropdownSectionFunction:AddSlider(Setting)
                    ...
                    SliderFrame.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
                    ...
                    SliderTitle.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
...
function sectionFunction:AddKeyBind(Setting, Callback)
    ...
    BindFrame.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
    ...
    BindButtonTitle.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
    ...
    return keybindFunction
			...
			function sectionFunction:AddInput(idk, Setting)
				...
				BoxFrame.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
				...
				Boxtitle.BackgroundColor3 = Color3.fromRGB(92, 52, 72)
