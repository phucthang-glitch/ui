...
local libCreateNoti = function(Setting)
	...
	Card.BackgroundColor3      = Color3.fromRGB(58, 28, 44)
...
function Library:CreateWindow(Setting)
	...
	-- TopBar (nav ngang)
	local Sidebar       = Instance.new("Frame")   -- giữ tên để tương thích
	local SideCorner    = Instance.new("UICorner")

	-- TopBar header (logo + title inline)
	...
	-- Active indicator (không dùng nhưng giữ để không lỗi)
	...
	-- -- TOPBAR NGANG (thay thế sidebar dọc) ----------------------
	-- Chiều cao: 90px (logo+title 50px + tabs 36px + 4px gap)
	local TOPBAR_H = 90
	...
	-- Bottom border accent topbar
	local sideRightBorder = Instance.new("Frame", Sidebar)
	sideRightBorder.Size = UDim2.new(0.85, 0, 0, 1)
	sideRightBorder.AnchorPoint = Vector2.new(0.5, 1)
	sideRightBorder.Position = UDim2.new(0.5, 0, 1, 0)
	...
	-- -- TOPBAR HEADER (logo + title, inline bên trái) ------------
	...
	SideHeader.Size = UDim2.new(0, 140, 0, 46)   -- nằm ngang bên trái
	...
	shGlow.Size = UDim2.new(1, 20, 1, 20)
	shGlow.ZIndex = 0
	...
	LogoImg.Position = UDim2.new(0, 8, 0.5, 0)
	...
	SubLbl.AnchorPoint = Vector2.new(0, 0)
	SubLbl.Position = UDim2.new(0, 40, 0, 24)
	SubLbl.Size = UDim2.new(1, -44, 0, 13)
	...
	-- Divider dọc sau header (phân cách header với tabs)
	HeaderDiv.Parent = Sidebar
	HeaderDiv.Position = UDim2.new(0, 144, 0, 6)
	...
	-- ActiveBar placeholder (không dùng)
	...
	-- -- TAB LIST NGANG (scroll X) --------------------------------
	ControlList.Name = "ControlList"
	ControlList.Parent = Sidebar
	ControlList.BackgroundTransparency = 1
	ControlList.BorderSizePixel = 0
	ControlList.Position = UDim2.new(0, 150, 0, 4)
	ControlList.Size = UDim2.new(1, -290, 0, 38)   -- để chỗ cho search bên phải
	...
	SideBottom.Position = UDim2.new(1, -4, 0, 23)
	SideBottom.Size = UDim2.new(0, 130, 0, 30)
	SideBottom.BackgroundTransparency = 1

	-- Divider dọc trước search
	local searchDiv = Instance.new("Frame", SideBottom)
	searchDiv.Size = UDim2.new(0, 1, 0.8, 0)
	searchDiv.AnchorPoint = Vector2.new(0, 0.5)
	searchDiv.Position = UDim2.new(0, -6, 0.5, 0)
	...
	function Main_Function:AddTab(PageName, IconId)
		...
		-- Wrapper: chiều rộng tự động theo text, cao 34px
		...
		PageNameControl.Size = UDim2.new(0, 0, 1, 0)   -- chiều cao = ControlList
		...
		-- Bottom indicator dot khi active (nằm dưới tab ngang)
		...
		InLine.Position = UDim2.new(0.5, 0, 1, -1)
		InLine.Size = UDim2.new(0.6, 0, 0, 3)
		local ilCorner = Instance.new("UICorner", InLine)
		ilCorner.CornerRadius = UDim.new(1, 0)

		-- TOP ACCENT BAR (thay vì left) khi active
		local LeftAccent = Instance.new("Frame", Frame)
		LeftAccent.Name = "LeftAccent"
		LeftAccent.Size = UDim2.new(0.7, 0, 0, 3)
		LeftAccent.AnchorPoint = Vector2.new(0.5, 0)
		LeftAccent.Position = UDim2.new(0.5, 0, 0, 0)
		...
		local tcPad = Instance.new("UIPadding", TabTitleContainer)
		tcPad.PaddingRight = UDim.new(0, 10)
