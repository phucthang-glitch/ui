...
mainButton.BackgroundColor3 = Color3.fromRGB(50, 22, 36)
...
UIS.InputEnded:Connect(function(input)
	...
	or input.UserInputType == Enum.UserInputType.Touch then
		...
		if math.abs(delta.X) < CLICK_DISTANCE and math.abs(delta.Y) < CLICK_DISTANCE then
			...
			if isToggled then
				TweenService:Create(mainButton, tweenOn, { BackgroundColor3 = Color3.fromRGB(50, 22, 36) }):Play()
			else
				TweenService:Create(mainButton, tweenOff, { BackgroundColor3 = Color3.fromRGB(36, 16, 26) }):Play()
			end
		end
		dragging = false
	end
...
mainButton.MouseEnter:Connect(function()
	...
	TweenService:Create(mainButton, hoverTweenInfo, { BackgroundColor3 = Color3.fromRGB(70, 30, 50) }):Play()
end)
...
mainButton.MouseButton1Down:Connect(function()
	TweenService:Create(mainButton, hoverTweenInfo, { Size = UDim2.new(0, 54, 0, 54), BackgroundColor3 = Color3.fromRGB(70, 30, 50) }):Play()
end)
...
NotiContainer.BackgroundColor3 = Color3.fromRGB(32, 16, 24)
...
local libCreateNoti = function(Setting)
	...
	NotiFrame.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
	...
	Noticontainer.BackgroundColor3 = Color3.fromRGB(52, 24, 38)
...
function Library:CreateWindow(Setting)
	...
	MainContainer.BackgroundColor3 = Color3.fromRGB(32, 16, 24)
	...
	TopBar.BackgroundColor3 = Color3.fromRGB(22, 10, 16)
	...
	SearchFrame.BackgroundColor3 = Color3.fromRGB(50, 22, 34)
	...
	function Main_Function:AddTab(PageName, IconId)
		...
		Frame.BackgroundColor3 = Color3.fromRGB(48, 22, 34)
		...
		for i, v in pairs(ControlList:GetChildren()) do
			if not v:IsA("UIListLayout") then
				if i == 2 then
					...
					v.Frame.BackgroundColor3 = Color3.fromRGB(80, 30, 50)
			...
			for _, v in next, ControlList:GetChildren() do
				if not v:IsA("UIListLayout") then
					...
					TweenService:Create(v.Frame,
						TweenInfo.new(getgenv().UIColor["Tween Animation 1 Speed"]),
						{
							BackgroundColor3 = isActive and Color3.fromRGB(80, 30, 50)
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			Section.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
			...
			LineShadow.BackgroundColor3 = Color3.fromRGB(80, 30, 50)
			...
			if Toggleable then
				...
				VisibilitySectionFrame.BackgroundColor3 = Color3.fromRGB(40, 18, 28)
			...
			local sectionFunction = {}
				...
				ToggleFrame.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
				...
				TogFrame1.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
				...
				checkbox.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
				...
				if Desc and Desc ~= "" then
					...
					ToggleDesc.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
				...
				ToggleTitle.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
				...
				ToggleBg.ZIndex = 0
				ToggleBg.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
				...
				ToggleButton.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
    ...
    ButtonClick()
			...
			function sectionFunction:AddButton(Setting, Callback)
				...
				Button.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
				...
				RowBG_1.BackgroundColor3 = Color3.fromRGB(64, 28, 46)
				...
				RowHover_1.BackgroundColor3 = Color3.fromRGB(80, 36, 56)
				...
				TextColor_1.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
				...
				if Desc and Desc ~= "" then
					...
					TextDesc.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
				...
				ImageLabel_1.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
				...
				Button_1.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
			...
			function sectionFunction:AddLabel(text)
                ...
                LabelFrame.BackgroundColor3 = Color3.fromRGB(38, 18, 28)
                ...
                LabelBG.BackgroundColor3 = Color3.fromRGB(52, 24, 38)
                ...
                TextColor.BackgroundColor3 = Color3.fromRGB(38, 18, 28)
            ...
            function sectionFunction:AddDropdownSection(Setting)
                ...
                DropdownFrame.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
                ...
                Dropdownbg.BackgroundColor3 = Color3.fromRGB(52, 26, 38)
                ...
                Topdrop.BackgroundColor3 = Color3.fromRGB(40, 20, 30)
                ...
                Dropdowntitle.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
                ...
                DropdownButton.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
                ...
                Dropdownlisttt.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
                
                DropdownScroll.Name = "DropdownScroll"
                DropdownScroll.Parent = Dropdownlisttt
                DropdownScroll.Active = true
                DropdownScroll.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
                ...
                ScrollContainer.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
                ...
                InternalSection.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
               ...
               local dropdownSectionFunction = {}
                ...
                function dropdownSectionFunction:AddSlider(Setting)
                    ...
                    SliderFrame.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
                    ...
                    SliderBG.BackgroundColor3 = Color3.fromRGB(36, 16, 26)
                    ...
                    SliderTitle.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
                    ...
                    SliderBar.BackgroundColor3 = Color3.fromRGB(60, 28, 44)
                    ...
                    Bar.BackgroundColor3 = Color3.fromRGB(70, 32, 50)
                    ...
                    Sliderboxframe.BackgroundColor3 = Color3.fromRGB(50, 22, 36)
                    ...
                    Sliderbox_2.BackgroundColor3 = Color3.fromRGB(50, 22, 36)
				...
				local function refreshlist(SortPairs)
					...
					if Selected then
                        for _, i in ipairs(OrderedList) do
							...
							SampleItem.BackgroundColor3 = Color3.fromRGB(58, 26, 42)
							...
							SampleItemBG.BackgroundColor3 = v and Color3.fromRGB(100, 255, 180) or Color3.fromRGB(70, 30, 50)
							...
							SampleItemTitle.BackgroundColor3 = Color3.fromRGB(58, 26, 42)
							...
							SampleItemButton.BackgroundColor3 = Color3.fromRGB(58, 26, 42)
...
function sectionFunction:AddKeyBind(Setting, Callback)
    ...
    BindFrame.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
    ...
    BindButtonTitle.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
    ...
    Bindkey.BackgroundColor3 = Color3.fromRGB(58, 26, 42)
    ...
    return keybindFunction
			...
			function sectionFunction:AddInput(idk, Setting)
				...
				BoxFrame.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
				...
				Boxtitle.BackgroundColor3 = Color3.fromRGB(44, 20, 32)
				...
				Boxxx.Parent = BoxCor
				Boxxx.BackgroundColor3 = Color3.fromRGB(58, 26, 42)
