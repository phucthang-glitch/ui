...
local T1UIColor = {
    ...
    ["Background Main Color"]         = Color3.fromRGB(32, 16, 24),   -- tím đen sâu
    ["Background 1 Color"]            = Color3.fromRGB(52, 26, 38),   -- tím tối (sáng hơn)
    ["Background 1 Transparency"]     = 0.0,
    ["Background 2 Color"]            = Color3.fromRGB(40, 20, 30),   -- tím đen (tối hơn)
    ["Background 3 Color"]            = Color3.fromRGB(46, 22, 34),   -- tím đen trung
    ["Background Image"]              = "",
    ...
    ["Button Color"]                  = Color3.fromRGB(58, 28, 42),
    ["Label Color"]                   = Color3.fromRGB(38, 18, 28),
    ...
    ["Slider Line Color"]             = Color3.fromRGB(70, 35, 50),
...
local libCreateNoti = function(Setting)
	...
	NotiFrame.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
...
function Library:CreateWindow(Setting)
	...
	local TAB_COLORS = {
		Color3.fromRGB(255, 130, 180),  -- hong chinh
		Color3.fromRGB(255, 180, 210),  -- hong nhat
		Color3.fromRGB(100, 230, 200),  -- mint
		Color3.fromRGB(255, 200, 100),  -- vang kem
		Color3.fromRGB(150, 200, 255),  -- xanh nhat
		Color3.fromRGB(200, 160, 255),  -- tim nhat
		Color3.fromRGB(255, 160, 100),  -- cam hong
		Color3.fromRGB(130, 255, 190),  -- xanh la neon
	}
	...
	Shadow.ImageColor3 = Color3.fromRGB(220, 80, 130)
	...
	MainContainer.BackgroundColor3 = Color3.fromRGB(60, 38, 49)
	...
	bgGrad.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0,    Color3.fromRGB(44, 20, 32)),
		ColorSequenceKeypoint.new(0.35, Color3.fromRGB(32, 16, 24)),
		ColorSequenceKeypoint.new(0.65, Color3.fromRGB(36, 18, 26)),
		ColorSequenceKeypoint.new(1,    Color3.fromRGB(42, 22, 32))
	}
	bgGrad.Rotation = 145
	...
	TopBar.BackgroundColor3 = Color3.fromRGB(50, 32, 41)
	...
	logoGrad.Color = ColorSequence.new{
		...
		ColorSequenceKeypoint.new(1, Color3.fromRGB(220, 60, 110))
	}
	...
	TitleLabel.Text = "<font color=\"rgb(255,160,200)\">" .. tostring(TitleNameMain) .. "</font>"
	...
	titleDiv.BackgroundColor3 = Color3.fromRGB(180, 60, 100)
	...
	SearchFrame.BackgroundColor3 = Color3.fromRGB(78, 44, 59)
	...
	sfStroke.Color = Color3.fromRGB(200, 80, 120)
	...
	SearchIcon.ImageColor3 = Color3.fromRGB(255, 120, 170)
	...
	SearchBox.PlaceholderColor3 = Color3.fromRGB(120, 70, 90)
	...
	tabDiv.BackgroundColor3 = Color3.fromRGB(180, 60, 100)
	...
	-- STATUS BAR (22px) ở đáy cửa sổ
	local StatusBar = Instance.new("Frame", MainContainer)
	StatusBar.Name = "StatusBar"
	StatusBar.AnchorPoint = Vector2.new(0, 1)
	StatusBar.Position = UDim2.new(0, 0, 1, 0)
	StatusBar.Size = UDim2.new(1, 0, 0, 22)
	StatusBar.BackgroundColor3 = Color3.fromRGB(30, 12, 20)
	StatusBar.BorderSizePixel = 0
	local sbCorner = Instance.new("UICorner", StatusBar)
	sbCorner.CornerRadius = UDim.new(0, 10)

	-- Top border line trên status bar
	local sbLine = Instance.new("Frame", StatusBar)
	sbLine.Size = UDim2.new(1, -20, 0, 1)
	sbLine.Position = UDim2.new(0, 10, 0, 0)
	sbLine.BackgroundColor3 = Color3.fromRGB(255, 120, 170)
	sbLine.BackgroundTransparency = 0.5
	sbLine.BorderSizePixel = 0
	local sbLineGrad = Instance.new("UIGradient", sbLine)
	sbLineGrad.Transparency = NumberSequence.new{
	...
	-- Clock label (trái)
	local ClockLabel = Instance.new("TextLabel", StatusBar)
	ClockLabel.Name = "ClockLabel"
	ClockLabel.BackgroundTransparency = 1
	ClockLabel.Position = UDim2.new(0, 10, 0, 0)
	ClockLabel.Size = UDim2.new(0, 80, 1, 0)
	ClockLabel.Font = Enum.Font.GothamBold
	ClockLabel.TextSize = 10
	ClockLabel.TextXAlignment = Enum.TextXAlignment.Left
	ClockLabel.TextColor3 = Color3.fromRGB(255, 160, 200)
	ClockLabel.Text = "00:00:00"

	-- Tab hiện tại (giữa)
	local ActiveTabLabel = Instance.new("TextLabel", StatusBar)
	ActiveTabLabel.Name = "ActiveTabLabel"
	ActiveTabLabel.BackgroundTransparency = 1
	ActiveTabLabel.AnchorPoint = Vector2.new(0.5, 0.5)
	ActiveTabLabel.Position = UDim2.new(0.5, 0, 0.5, 0)
	ActiveTabLabel.Size = UDim2.new(0.4, 0, 1, 0)
	ActiveTabLabel.Font = Enum.Font.GothamBold
	ActiveTabLabel.TextSize = 10
	ActiveTabLabel.TextXAlignment = Enum.TextXAlignment.Center
	ActiveTabLabel.TextColor3 = Color3.fromRGB(255, 200, 220)
	ActiveTabLabel.Text = ""
	getgenv()._BHActiveTabLabel = ActiveTabLabel

	-- Credit (phải)
	local CreditLabel = Instance.new("TextLabel", StatusBar)
	CreditLabel.BackgroundTransparency = 1
	CreditLabel.AnchorPoint = Vector2.new(1, 0.5)
	CreditLabel.Position = UDim2.new(1, -10, 0.5, 0)
	CreditLabel.Size = UDim2.new(0, 100, 1, 0)
	CreditLabel.Font = Enum.Font.Gotham
	CreditLabel.TextSize = 9
	CreditLabel.TextXAlignment = Enum.TextXAlignment.Right
	CreditLabel.TextColor3 = Color3.fromRGB(160, 80, 110)
	CreditLabel.Text = "BananaHub"

	-- Clock update mỗi giây
	local _clockConn
	_clockConn = game:GetService("RunService").Heartbeat:Connect(function()
		if not ClockLabel or not ClockLabel.Parent then
			_clockConn:Disconnect()
			return
		end
		local t = os.time()
		...
		local s = t%60
		ClockLabel.Text = string.format("%02d:%02d:%02d", h, m2, s)
	end)
	...
	Concacontainer.Size = UDim2.new(1, 0, 1, -89)
	...
	function Main_Function:AddTab(PageName, IconId)
		...
		Frame.BackgroundColor3 = Color3.fromRGB(76, 44, 59)
		...
		TabTitle.TextColor3 = Color3.fromRGB(180, 100, 130)
		...
		-- Set active tab label lần đầu
		if LayoutOrderBut == 0 and getgenv()._BHActiveTabLabel then
			getgenv()._BHActiveTabLabel.Text = Page_Name
		end
		...
		for i, v in pairs(ControlList:GetChildren()) do
			if not v:IsA("UIListLayout") then
				if i == 2 then
					...
					v.Frame.BackgroundColor3 = Color3.fromRGB(108, 52, 75)
		...
		PageButton.MouseButton1Click:Connect(function()
			-- Ripple effect hồng khi click
			local rip = Instance.new("Frame", Frame)
			rip.AnchorPoint = Vector2.new(0.5, 0.5)
			rip.Position = UDim2.new(0.5, 0, 0.5, 0)
			rip.Size = UDim2.new(0, 0, 0, 0)
			rip.BackgroundColor3 = Color3.fromRGB(255, 150, 190)
			rip.BackgroundTransparency = 0.4
			rip.BorderSizePixel = 0
			rip.ZIndex = 5
			local ripCorner = Instance.new("UICorner", rip)
			ripCorner.CornerRadius = UDim.new(1, 0)
			TweenService:Create(rip, TweenInfo.new(0.35, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
			...
			-- Cập nhật status bar
			if getgenv()._BHActiveTabLabel then
				getgenv()._BHActiveTabLabel.Text = Page_Name
			end
			...
			for _, v in next, ControlList:GetChildren() do
				if not v:IsA("UIListLayout") then
					...
					TweenService:Create(v.Frame,
						TweenInfo.new(getgenv().UIColor["Tween Animation 1 Speed"]),
						{
							BackgroundColor3 = isActive and Color3.fromRGB(108, 52, 75)
								or Color3.fromRGB(48, 22, 34),
					...
					TweenService:Create(v.Frame.TabTitleContainer.TabTitle,
						TweenInfo.new(getgenv().UIColor["Tween Animation 1 Speed"]),
						{ TextColor3 = isActive and tc or Color3.fromRGB(180, 100, 130) }):Play()
				end
			end
		end)
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			Section.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
			...
			sectionGradient.Color = ColorSequence.new{
				ColorSequenceKeypoint.new(0, Color3.fromRGB(42, 20, 30)),
				ColorSequenceKeypoint.new(1, Color3.fromRGB(42, 20, 30))
			}
			...
			local sectionFunction = {}
				...
				ToggleFrame.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
				...
				TogFrame1.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
				...
				checkbox.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
				...
				if Desc and Desc ~= "" then
					...
					ToggleDesc.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
				...
				ToggleTitle.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
				...
				toggleBgGrad.Color = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(52, 24, 38)),
							ColorSequenceKeypoint.new(1, Color3.fromRGB(46, 22, 34))
				}
				toggleBgGrad.Rotation = 0
				ToggleBg.ZIndex = 0
				ToggleBg.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
				...
				ToggleButton.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
    ...
    ButtonClick()
			...
			function sectionFunction:AddButton(Setting, Callback)
				...
				Button.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
				...
				TextColor_1.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
				...
				if Desc and Desc ~= "" then
					...
					TextDesc.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
				...
				ImageLabel_1.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
				...
				Button_1.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
            ...
            function sectionFunction:AddDropdownSection(Setting)
                ...
                DropdownFrame.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
                ...
                Dropdowntitle.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
                ...
                DropdownButton.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
                ...
                Dropdownlisttt.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
                
                DropdownScroll.Name = "DropdownScroll"
                DropdownScroll.Parent = Dropdownlisttt
                DropdownScroll.Active = true
                DropdownScroll.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
                ...
                ScrollContainer.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
                ...
                InternalSection.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
               ...
               local dropdownSectionFunction = {}
                ...
                function dropdownSectionFunction:AddSlider(Setting)
                    ...
                    SliderFrame.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
                    ...
                    SliderTitle.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
...
function sectionFunction:AddKeyBind(Setting, Callback)
    ...
    BindFrame.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
    ...
    BindButtonTitle.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
    ...
    return keybindFunction
			...
			function sectionFunction:AddInput(idk, Setting)
				...
				BoxFrame.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
				...
				Boxtitle.BackgroundColor3 = Color3.fromRGB(72, 42, 57)
