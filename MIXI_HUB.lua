-- MIXI HUB - CYBERPUNK DARK EDITION
-- Theme: Đen/xanh nước + Cyan neon + Vàng gold
-- Logic giữ nguyên từ bản gốc, giao diện thiết kế lại 100%

if getgenv().Nousigi then 
	if game.CoreGui:FindFirstChild("MIXI Hub GUI") then
		for i, v in ipairs(game.CoreGui:GetChildren()) do
			if string.find(v.Name, "MIXI Hub") then
				v:Destroy()
			end
		end
	end
...
-- Nền đen xanh nước + accent cyan neon + chữ vàng gold
-- ============================================================
local T1UIColor = {
    -- Accent / border
    ["Border Color"]                  = Color3.fromRGB(0, 185, 225),
    ["Click Effect Color"]            = Color3.fromRGB(0, 200, 240),
    ["Setting Icon Color"]            = Color3.fromRGB(100, 220, 255),
    ["Logo Image"]                    = "rbxassetid://123613996022560",
    ["Search Icon Color"]             = Color3.fromRGB(0, 185, 225),
    ["Search Icon Highlight Color"]   = Color3.fromRGB(100, 220, 255),
    ...
    ["Placeholder Text Color"]        = Color3.fromRGB(40, 90, 125),
    ["Title Text Color"]              = Color3.fromRGB(100, 220, 255),

    -- Background sáng tối xen kẽ
    ["Background Main Color"]         = Color3.fromRGB(10, 32, 50),   -- tím đen sâu
    ["Background 1 Color"]            = Color3.fromRGB(14, 42, 64),   -- tím tối (sáng hơn)
    ["Background 1 Transparency"]     = 0.0,
    ["Background 2 Color"]            = Color3.fromRGB(12, 36, 56),   -- tím đen (tối hơn)
    ["Background 3 Color"]            = Color3.fromRGB(13, 38, 58),   -- tím đen trung
    ["Background Image"]              = "",
    ...
    ["Section Underline Color"]       = Color3.fromRGB(0, 185, 225),
    -- Toggle: xanh lá check
    ["Toggle Border Color"]           = Color3.fromRGB(100, 255, 180),
    ["Toggle Checked Color"]          = Color3.fromRGB(100, 255, 180),
    ["Toggle Desc Color"]             = Color3.fromRGB(100, 185, 215),

    -- Button: nền sáng hơn section
    ["Button Color"]                  = Color3.fromRGB(16, 44, 68),
    ["Label Color"]                   = Color3.fromRGB(12, 34, 54),
    ["Dropdown Icon Color"]           = Color3.fromRGB(0, 190, 230),
    ["Dropdown Selected Color"]       = Color3.fromRGB(0, 185, 225),
    ["Dropdown Selected Check Color"] = Color3.fromRGB(100, 255, 180),

    ["Textbox Highlight Color"]       = Color3.fromRGB(0, 185, 225),
    ["Box Highlight Color"]           = Color3.fromRGB(0, 155, 195),
    ["Slider Line Color"]             = Color3.fromRGB(18, 50, 78),
    ["Slider Highlight Color"]        = Color3.fromRGB(0, 185, 225),
...
Library_Function.Gui.Name = 'MIXI Hub GUI'
...
mainButton.BackgroundColor3 = Color3.fromRGB(16, 44, 66)
mainButton.BackgroundTransparency = 0
mainButton.AutoButtonColor = false
mainButton.Image = "rbxassetid://123613996022560"
mainButton.ImageColor3 = Color3.fromRGB(0, 190, 230)
...
mainBtnGrad.Color = ColorSequence.new{
	ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 185, 225)),
		ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 160, 210)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 185, 225))
}
...
innerGlow.BackgroundColor3 = Color3.fromRGB(0, 165, 205)
...
UIS.InputEnded:Connect(function(input)
	...
	or input.UserInputType == Enum.UserInputType.Touch then
		...
		if math.abs(delta.X) < CLICK_DISTANCE and math.abs(delta.Y) < CLICK_DISTANCE then
			...
			if isToggled then
				TweenService:Create(mainButton, tweenOn, { BackgroundColor3 = Color3.fromRGB(16, 44, 66) }):Play()
			else
				TweenService:Create(mainButton, tweenOff, { BackgroundColor3 = Color3.fromRGB(13, 40, 62) }):Play()
			end
		end
		dragging = false
	end
...
mainButton.MouseEnter:Connect(function()
	...
	TweenService:Create(mainButton, hoverTweenInfo, { BackgroundColor3 = Color3.fromRGB(20, 60, 90) }):Play()
end)

mainButton.MouseLeave:Connect(function()
	local targetColor = isToggled and Color3.fromRGB(10, 30, 50) or Color3.fromRGB(8, 24, 40)
...
mainButton.MouseButton1Down:Connect(function()
	TweenService:Create(mainButton, hoverTweenInfo, { Size = UDim2.new(0, 54, 0, 54), BackgroundColor3 = Color3.fromRGB(20, 60, 90) }):Play()
end)
...
Library.DestroyUI = function()
	if game.CoreGui:FindFirstChild("MIXI Hub GUI") then
		for i, v in ipairs(game.CoreGui:GetChildren()) do
			if string.find(v.Name, "MIXI Hub") then v:Destroy() end
		end
	end
...
local NOTI_TYPES = {
	...
	default = {
		...
		accent   = Color3.fromRGB(0, 185, 225),
...
local libCreateNoti = function(Setting)
	...
	Card.BackgroundColor3      = Color3.fromRGB(12, 34, 54)
	...
	cardGrad.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(14, 40, 62)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(10, 32, 52)),
	}
	...
	if Description ~= "" then
		...
		DescLbl.TextColor3    = Color3.fromRGB(150, 215, 240)
	...
	CloseBtn.TextColor3   = Color3.fromRGB(80, 175, 215)
	CloseBtn.ZIndex       = 10
	...
	ProgressBg.BackgroundColor3  = Color3.fromRGB(8, 24, 40)
	...
	CloseBtn.MouseEnter:Connect(function()
		TweenService:Create(CloseBtn, TweenInfo.new(0.12),
			{ TextColor3 = Color3.fromRGB(0, 200, 240) }):Play()
	end)
	CloseBtn.MouseLeave:Connect(function()
		TweenService:Create(CloseBtn, TweenInfo.new(0.12),
			{ TextColor3 = Color3.fromRGB(80, 175, 215) }):Play()
	end)
...
-- Theme: Ocean Dark  -  nền xanh nước đen, accent cyan neon
-- ============================================================
function Library:CreateWindow(Setting)
	local TitleNameMain = Setting.Title or "MIXI HUB"
	...
	Shadow.ImageColor3 = Color3.fromRGB(0, 140, 185)
	...
	MainContainer.BackgroundColor3 = Color3.fromRGB(14, 42, 64)
	...
	mainStroke.Color = Color3.fromRGB(0, 185, 225)

	local bgGrad = Instance.new("UIGradient", MainContainer)
	bgGrad.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0,    Color3.fromRGB(14, 38, 58)),
		ColorSequenceKeypoint.new(0.5,  Color3.fromRGB(10, 30, 48)),
		ColorSequenceKeypoint.new(1,    Color3.fromRGB(12, 34, 54))
	}
	bgGrad.Rotation = 120
	...
	Sidebar.BackgroundColor3 = Color3.fromRGB(12, 34, 54)
	...
	sideGrad.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(14, 38, 58)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(10, 30, 48))
	}
	...
	sideRightBorder.BackgroundColor3 = Color3.fromRGB(0, 185, 225)
	...
	SideHeader.BackgroundColor3 = Color3.fromRGB(0, 165, 205)
	...
	shGrad.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 175, 215)),
		ColorSequenceKeypoint.new(0.6, Color3.fromRGB(0, 150, 190)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 120, 165))
	}
	shGrad.Rotation = 135
	...
	shGlow.ImageColor3 = Color3.fromRGB(0, 185, 225)
	...
	LogoImg.ImageColor3 = Color3.fromRGB(220, 248, 255)
	...
	TitleLbl.TextColor3 = Color3.fromRGB(220, 248, 255)
	...
	SubLbl.TextColor3 = Color3.fromRGB(200, 240, 255)
	...
	HeaderDiv.BackgroundColor3 = Color3.fromRGB(0, 185, 225)
	...
	-- ActiveBar floating bị loại bỏ hoàn toàn (gây bug phân thân khi scroll).
	-- Highlight xử lý trực tiếp trên Frame từng tab.
	...
	searchDiv.BackgroundColor3 = Color3.fromRGB(0, 185, 225)
	...
	SearchFrame.BackgroundColor3 = Color3.fromRGB(13, 38, 60)
	...
	sfStroke.Color = Color3.fromRGB(0, 165, 205)
	...
	SearchIcon.ImageColor3 = Color3.fromRGB(0, 185, 225)
	...
	SearchBox.PlaceholderColor3 = Color3.fromRGB(50, 105, 135)
	SearchBox.PlaceholderText = "Tim kiem..."
	SearchBox.Text = ""
	SearchBox.TextColor3 = Color3.fromRGB(200, 240, 255)
	...
	ClearBtn.TextColor3 = Color3.fromRGB(0, 190, 230)
	...
	ContentBg.BackgroundColor3 = Color3.fromRGB(13, 38, 60)
	...
	contentStroke.Color = Color3.fromRGB(0, 165, 205)
	...
	contentGrad.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(15, 42, 64)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(13, 38, 58))
	}
	...
	function Main_Function:AddTab(PageName, IconId)
		...
		Frame.BackgroundColor3 = Color3.fromRGB(14, 38, 58)
		...
		-- LEFT ACCENT BAR gắn thẳng vào Frame (không bao giờ lệch dù scroll)
		local LeftAccent = Instance.new("Frame", Frame)
		...
		LeftAccent.BackgroundColor3 = tabColor
		LeftAccent.BackgroundTransparency = 1   -- ẩn mặc định
		LeftAccent.BorderSizePixel = 0
		LeftAccent.ZIndex = 5
		local lacCorner = Instance.new("UICorner", LeftAccent)
		lacCorner.CornerRadius = UDim.new(1, 0)
		...
		if LayoutOrderBut == 0 then
			...
			Frame.BackgroundColor3 = Color3.fromRGB(0, 165, 205)
			...
			LeftAccent.BackgroundTransparency = 0   -- hiện accent bar tab đầu
		end
		...
		PageButton.MouseButton1Click:Connect(function()
			...
			for _, v in next, ControlList:GetChildren() do
				if not v:IsA("UIListLayout") then
					...
					if vFrame then
						local tc = tabColor
						-- Lấy màu riêng của tab đó qua LeftAccent
						local vLA = vFrame:FindFirstChild("LeftAccent")
						if vLA then tc = vLA.BackgroundColor3 end

						TweenService:Create(vFrame, TweenInfo.new(0.18), {
							BackgroundColor3 = isActive
								and Color3.fromRGB(0, 165, 205)
								or  Color3.fromRGB(14, 38, 58),
							BackgroundTransparency = isActive and 0.75 or 1
						}):Play()

						-- Left accent bar: hiện/ẩn tức thì (không tween để không lệch)
						if vLA then
							vLA.BackgroundTransparency = isActive and 0 or 1
						end
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			sectionStroke.Color = Color3.fromRGB(0, 155, 195)
			...
			sectionGradient.Color = ColorSequence.new{
				ColorSequenceKeypoint.new(0, Color3.fromRGB(14, 38, 58)),
				ColorSequenceKeypoint.new(1, Color3.fromRGB(14, 38, 58))
			}
			...
			topsecGlow.ImageColor3 = Color3.fromRGB(0, 185, 225)
			...
			secAccentBar.BackgroundColor3 = Color3.fromRGB(0, 185, 225)
			...
			Linesec.BackgroundColor3 = Color3.fromRGB(0, 185, 225)
			...
			local sectionFunction = {}
				...
				if Desc and Desc ~= "" then
					...
					ToggleDesc.TextColor3 = Color3.fromRGB(100, 185, 215)
				...
				toggleBgGrad.Color = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(14, 42, 65)),
							ColorSequenceKeypoint.new(1, Color3.fromRGB(13, 38, 58))
				}
    ...
    ButtonClick()
			...
			function sectionFunction:AddButton(Setting, Callback)
				...
				if Desc and Desc ~= "" then
					...
					TextDesc.Text = Desc
					TextDesc.TextColor3 = Color3.fromRGB(100, 185, 215)
            ...
            function sectionFunction:AddDropdownSection(Setting)
                ...
                Dropdowntitle.TextColor3 = Color3.fromRGB(0, 190, 230)
                ...
                DropdownButton.Text = ""
                DropdownButton.TextColor3 = Color3.fromRGB(0, 190, 230)
               ...
               local dropdownSectionFunction = {}
                ...
                function dropdownSectionFunction:AddSlider(Setting)
                    ...
                    SliderBG.BackgroundColor3 = Color3.fromRGB(13, 40, 62)
                    ...
                    SliderButton.BackgroundColor3 = Color3.fromRGB(0, 185, 225)
                    SliderButton.BackgroundTransparency = 1.000
                    SliderButton.Size = UDim2.new(1, 0, 1, 0)
                    SliderButton.Font = Enum.Font.GothamBold
                    SliderButton.Text = ""
                    SliderButton.TextColor3 = Color3.fromRGB(220, 248, 255)
                    ...
                    Sliderboxframe.BackgroundColor3 = Color3.fromRGB(16, 44, 66)
                    ...
                    Sliderbox_2.BackgroundColor3 = Color3.fromRGB(16, 44, 66)
                    ...
                    SliderButton.MouseEnter:Connect(function()
                        TweenService:Create(Bar, TweenInfo.new(getgenv().UIColor["Tween Animation 2 Speed"]), {
                            BackgroundColor3 = Color3.fromRGB(0, 185, 225)
                        }):Play()
                    end)
				...
				local function refreshlist(SortPairs)
					...
					if Selected then
                        for _, i in ipairs(OrderedList) do
							...
							SampleItemBG.BackgroundColor3 = v and Color3.fromRGB(100, 255, 180) or Color3.fromRGB(20, 60, 90)
							...
							SampleItemButton.TextColor3 = Color3.fromRGB(200, 240, 255)
